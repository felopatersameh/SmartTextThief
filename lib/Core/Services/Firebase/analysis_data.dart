...
//       return [
//         DataModel(name: 'Exams Created', value: exams.length),
//         DataModel(name: 'Subjects Created', value: subjects.length),
//         DataModel(name: 'Ended Exams', value: endedExam),
//         DataModel(name: 'Running Exams', value: runningExam),
//       ];
//     } catch (_) {
...
//     return [
//       DataModel(name: 'Exams Created', value: 0),
//       DataModel(name: 'Subjects Created', value: 0),
//       DataModel(name: 'Ended Exams', value: 0),
//       DataModel(name: 'Running Exams', value: 0),
//     ];
//   }

//   static List<DataModel> _defaultStudentData() {
//     return [
//       DataModel(name: 'Done Exams', value: 0),
//       DataModel(name: 'GPA', value: 0.0),
//       DataModel(name: 'Level Student', value: -1, valueString: 'none'),
//       DataModel(name: 'From 0', value: -1, valueString: '0'),
//     ];
//   }
