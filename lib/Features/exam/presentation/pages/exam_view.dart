...
import 'package:smart_text_thief/Features/exam/presentation/widgets/exam_shell.dart';
import 'package:smart_text_thief/Features/exam/domain/enums/exam_mode.dart';
import 'package:smart_text_thief/Features/exam/presentation/widgets/exam_info_card.dart';
import 'package:smart_text_thief/Features/exam/presentation/widgets/exam_question_card.dart';
import 'package:smart_text_thief/Features/exam/presentation/widgets/exam_questions_list.dart';
import 'package:smart_text_thief/Features/exam/presentation/widgets/exam_date_section.dart'
    as exam_date;
import 'package:smart_text_thief/Features/exam/presentation/widgets/student_selector.dart';
    ...
    return ExamShell(
      ...
      child: Column(
        ...
        children: [
          ...
          if (_isTeacherResultMode && (examResults ?? const <ExamResultModel>[]).isNotEmpty) ...[
            _buildTeacherTabs(),
            SizedBox(height: 16.h),
          ],
