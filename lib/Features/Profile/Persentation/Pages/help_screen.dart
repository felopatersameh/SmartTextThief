      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            _buildSectionTitle('Advanced Analysis'),
            const SizedBox(height: 12),
            _buildInfoCard(const [
              'Every exam has dedicated analysis (scores, distribution, and performance context).',
              'Every subject has analysis and dashboard indicators for instructors.',
              'Every user has personal analysis to track progress and weak points.',
            ]),
            const SizedBox(height: 24),
            _buildSectionTitle('AI Models and Generation Strategy'),
            const SizedBox(height: 12),
            _buildInfoCard(const [
              'The app supports multiple Gemini models instead of relying on a single model.',
              'If one model is unavailable or reaches limits, generation can move to the next model.',
              'Goal: stable generation quality with fewer interruptions.',
            ]),
            const SizedBox(height: 24),
            _buildSectionTitle('Teacher Control and Student Assessment'),
            const SizedBox(height: 12),
            _buildInfoCard(const [
              'Instructors have expanded control over subject management and exam operations.',
              'Students receive more personal assessment context to improve learning outcomes.',
              'Product direction focuses on easier workflows with high-quality results.',
            ]),
            const SizedBox(height: 24),
            _buildSectionTitle('Future Roadmap'),
            const SizedBox(height: 12),
            _buildInfoCard(const [
              'Plans and subscription structure expansion.',
              'Workshops for instructors.',
              'Ads support as part of future growth strategy.',
